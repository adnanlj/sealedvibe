...
import { Heart, Mail, Lock, Eye, EyeOff, AlertCircle, Loader2, ArrowRight, Sparkles } from "lucide-react";
    ...
    <div className="min-h-screen bg-[#06050e] text-slate-100 flex flex-col items-center justify-center p-6 relative overflow-hidden selection:bg-amber-500/30 selection:text-amber-200">
      ...
      >
        ...
        <div className="text-center space-y-2">
          ...
          <h2 className="text-2xl font-bold text-white pt-2 font-serif italic">Welcome Back</h2>
          <p className="text-xs text-slate-300 font-light">Sign in to manage your 3D websites and live tracking receipts.</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div className="flex justify-end">
            <Link
              ...
              className="text-[11px] text-amber-400/90 hover:text-amber-300 font-bold transition-colors"
            >
              Forgot password?
            </Link>
          </div>
          ...
          >
            {loading ? <Loader2 className="w-4 h-4 animate-spin" /> : <>Sign In to Account <ArrowRight className="w-4 h-4" /></>}
          </button>
        </form>
        ...
        <div className="text-center pt-2">
          <p className="text-xs text-slate-400">
            ...
            <Link href="/signup" className="text-amber-300 font-bold hover:underline">
              Create one for free
            </Link>
          </p>
        </div>
